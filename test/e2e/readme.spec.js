...
describe('README => ', () => {
  ...
  describe('Button Icons', () => {
    it('should be equal to the taken screenshot', async () => {
      ...
      await appOverview.openSheet('README:button-icons');

      await browser.wait(EC.visibilityOf($(selectors.qvtSheet)), timeoutTime, 'Sheet was not visible');

      return expect(await browser.takeImageOf({selector: selectors.qvtSheet})).to.matchImageOf('button_icons', 'readme');
    });
  });
