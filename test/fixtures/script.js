...
function addExtension( args ) { // eslint-disable-line 

  let dataDef = args[0] && JSON.parse(args[0]) || []; // eslint-disable-line no-mixed-operators
  let options = args[1] && JSON.parse(args[1]) || {}; // eslint-disable-line no-mixed-operators
